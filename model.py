...
def get_rotary_embeddings(head_dim, max_token_length, base=10000):
    ...
    )  # dimension-wise rotation; shape: # [1, head_dim/2]
    t = torch.arange(0, max_token_length, dtype=torch.float).unsqueeze(
        1
    )  # [max_tok_length, 1]
...
class CausalSelfAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        k = k.transpose(1, 2)
        v = v.transpose(1, 2)
        cos, sin = self.cos[:T, :].unsqueeze(0).unsqueeze(0), self.sin[:T, :].unsqueeze(
            0
        ).unsqueeze(0)
...
def main():
    ...
    "us", "mi", "il", "ch", "mo", "im", "ca", "ot", "fo", "pe",
    "lo", "ad", "un", "so", "po", "fa", "ir", "pa", "su", "do",
    "vi", "pr", "wh", "fr", "pl", "tr", "cl", "sh", "bl", "fl",
    "gr", "sp", "sc", "br", "gl", "cr", "sl", "tw", "dr", "sw",
    "qu", "sm", "sk", "ph", "wr", "kn", "gn", "dw",
    
    # Y-suffix phonetic patterns
    "hy", "cy", "fy", "gy", "ly", "my", "ny", "py", "ry", "sy",
    "ty", "vy", "zy", "by", "dy", "ky", "ay", "ey", "oy", "uy",

    # Common vowel clusters
    "ia", "ie", "ei", "ai", "au", "ou", "eu", "ui", "ue", "oa",
    "oe", "oo", "ua", "uo", "aa", "ee", "ii", "uu",

    # Common consonant repetitions
    "bb", "cc", "dd", "ff", "gg", "hh", "jj", "kk", "ll", "mm",
    "nn", "pp", "qq", "rr", "ss", "tt", "vv", "ww", "xx", "yy", "zz",

    # Common 3-grams
    "the", "and", "tha", "ent", "ing", "ion", "tio", "for", "nde",
    "has", "nce", "edt", "tis", "oft", "sth", "men", "her", "ere",
    "his", "ver", "all", "wit", "thi", "ter", "est", "ers", "ati",
    "hat", "ate", "rea", "con", "int", "res", "pro", "ect", "com",
    "per", "sta", "ear", "art", "ess", "not", "ive", "eve", "ove",
    "our", "but", "are", "one", "oul", "out", "hin"
    }
